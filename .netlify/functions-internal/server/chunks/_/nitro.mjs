...
function _() {
  return (
    Object.assign(c$1.prototype, i$1.prototype),
    Object.assign(c$1.prototype, l$1.prototype),
    c$1
  );
}
function g(...n) {
...
function setCookie(event, name, value, serializeOptions = {}) {
  ...
  const currentCookies = splitCookiesString(event.node.res.getHeader('set-cookie'));
  ...
  class o {
    ...
    compare(t, r) {
      ...
      return e === 'string' && n === 'string'
        ...
        : e === 'number' && n === 'number'
          ? t - r
          : String.prototype.localeCompare.call(this.serialize(t, true), this.serialize(r, true));
    }
    serialize(t, r) {
    ...
    serializeObject(t) {
      ...
      if (r !== '[object Object]')
        return this.serializeBuiltInType(r.length < 10 ? `unknown:${r}` : r.slice(8, -1), t);
      ...
      if (typeof t.toJSON == 'function') {
        const i = t.toJSON();
        return (
          n + (i !== null && typeof i == 'object' ? this.$object(i) : `(${this.serialize(i)})`)
        );
      }
    ...
    $object(t) {
      ...
      return (
        r === void 0 &&
          (this.#t.set(t, `#${this.#t.size}`), (r = this.serializeObject(t)), this.#t.set(t, r)),
        r
      );
    }
    $function(t) {
      ...
      return r.slice(-15) === '[native code] }'
        ? `${t.name || ''}()[native]`
        : `${t.name}(${t.length})${r.replace(/\s*\n\s*/g, '')}`;
    }
    $Array(t) {
      let r = '[';
      for (let e = 0; e < t.length; e++)
        ((r += this.serialize(t[e])), e < t.length - 1 && (r += ','));
      return r + ']';
    }
    $Date(t) {
      try {
...
const plugins = [_8DMshMd3any6LBCWcXm62jRnlohFo_8uqf_QtoLmoCY];
...
const handlers = [
  ...
  },
  {
    ...
    handler: _lazy_jZsVHT,
    lazy: true,
    middleware: false,
    method: undefined,
  },
  {
    route: '/api/auth/refreshSession',
    handler: _lazy_opN7kH,
    lazy: true,
    middleware: false,
    method: undefined,
  },
  ...
  },
  {
    ...
    handler: _lazy_DxQ8w4,
    lazy: true,
    middleware: false,
    method: undefined,
  },
  {
    route: '/api/departments/editDepartment',
    handler: _lazy_ilixlA,
    lazy: true,
    middleware: false,
    method: undefined,
  },
  {
    ...
    handler: _lazy_TdWHxD,
    lazy: true,
    middleware: false,
    method: undefined,
  },
  {
    route: '/api/departments/newDepartment',
    handler: _lazy_jeUSBV,
    lazy: true,
    middleware: false,
    method: undefined,
  },
  {
    route: '/api/entitlement/add',
    handler: _lazy_E80TJ9,
    lazy: true,
    middleware: false,
    method: undefined,
  },
  {
    route: '/api/entitlement/delete',
    handler: _lazy_o09WNg,
    lazy: true,
    middleware: false,
    method: undefined,
  },
  {
    route: '/api/entitlement/get',
    handler: _lazy_pMel9Y,
    lazy: true,
    middleware: false,
    method: undefined,
  },
  {
    route: '/api/entitlement/massLeaves',
    handler: _lazy_oKVIkm,
    lazy: true,
    middleware: false,
    method: undefined,
  },
  {
    route: '/api/entitlement/massRemote',
    handler: _lazy_dto34a,
    lazy: true,
    middleware: false,
    method: undefined,
  },
  {
    route: '/api/entitlement/update',
    handler: _lazy_QVUws6,
    lazy: true,
    middleware: false,
    method: undefined,
  },
  {
    route: '/api/leaves/cancelLeave',
    handler: _lazy_DZWWws,
    lazy: true,
    middleware: false,
    method: undefined,
  },
  {
    route: '/api/leaves/getAllForAllUsers',
    handler: _lazy_CVTzEn,
    lazy: true,
    middleware: false,
    method: undefined,
  },
  {
    route: '/api/leaves/getLeavesAvailableDays',
    handler: _lazy_9qLHrR,
    lazy: true,
    middleware: false,
    method: undefined,
  },
  {
    route: '/api/leaves/getLeavesByUser',
    handler: _lazy_X90JgF,
    lazy: true,
    middleware: false,
    method: undefined,
  },
  {
    route: '/api/leaves/getLeavesStatuses',
    handler: _lazy_cnTHdF,
    lazy: true,
    middleware: false,
    method: undefined,
  },
  {
    route: '/api/leaves/getLeavesTypes',
    handler: _lazy_Y9tQxc,
    lazy: true,
    middleware: false,
    method: undefined,
  },
  {
    route: '/api/leaves/newLeave',
    handler: _lazy_c3qCGE,
    lazy: true,
    middleware: false,
    method: undefined,
  },
  {
    route: '/api/leaves/processLeave',
    handler: _lazy_nRNfhJ,
    lazy: true,
    middleware: false,
    method: undefined,
  },
  { route: '/api/me', handler: _lazy_mSyVuM, lazy: true, middleware: false, method: undefined },
  {
    ...
    handler: _lazy_xE1UZ_,
    lazy: true,
    middleware: false,
    method: undefined,
  },
  {
    route: '/api/notifications/markedRead',
    handler: _lazy_4KOKjm,
    lazy: true,
    middleware: false,
    method: undefined,
  },
  {
    route: '/api/notifications/markedUnread',
    handler: _lazy_w99nqI,
    lazy: true,
    middleware: false,
    method: undefined,
  },
...
export {
  ...
  withoutTrailingSlash as P,
  normalizeCookieHeader as a,
  normalizeLambdaOutgoingBody as b,
  normalizeLambdaOutgoingHeaders as c,
  defineEventHandler as d,
  useRuntimeConfig as e,
  createJWT as f,
  getRouteRulesForPath as g,
  createError$1 as h,
  getCookie as i,
  deleteCookie as j,
  setHeader as k,
  joinRelativeURL as l,
  getResponseStatusText as m,
  normalizeLambdaIncomingHeaders as n,
