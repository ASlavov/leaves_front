...
const massRemote = defineEventHandler(async (event) => {
  ...
  try {
    ...
    console.log(body);
    const response = await $fetch(`${config.public.apiBase}${config.public.entitlement.massRemote}`, {
      method: "POST",
      body: {
        userIds,
...
export { massRemote as default };
//# sourceMappingURL=massRemote.mjs.map
