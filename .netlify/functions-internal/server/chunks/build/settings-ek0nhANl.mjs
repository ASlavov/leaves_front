import { computed, ref, watch, createVNode, resolveDynamicComponent, mergeProps, unref, withCtx, createBlock, createTextVNode, openBlock, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderList, ssrRenderClass, ssrRenderAttr, ssrInterpolate, ssrRenderVNode, ssrRenderAttrs, ssrRenderStyle, ssrIncludeBooleanAttr } from 'vue/server-renderer';
  ...
  setup(__props) {
    ...
    const filteredResults = computed(() => {
      ...
      return items.value.filter(
        (item) => item.name.toLowerCase().includes(searchQuery.value.toLowerCase()) || item.department.name.toLowerCase().includes(searchQuery.value.toLowerCase())
      );
    });
    ...
    const firstName = computed(() => {
      var _a, _b;
      return ((_b = (_a = selectedUser.value) == null ? void 0 : _a.name) == null ? void 0 : _b.split(" ")[0]) || "";
    });
    const lastName = computed(() => {
      var _a, _b;
      return ((_b = (_a = selectedUser.value) == null ? void 0 : _a.name) == null ? void 0 : _b.split(" ").slice(1).join(" ")) || "";
    });
...
_sfc_main$h.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/SidebarTopbar/Search.vue");
...
const _sfc_main$g = {
  ...
  setup(__props) {
    ...
    const user = computed(() => {
      ...
      const nameSplit = ((_a = userInfo == null ? void 0 : userInfo.name) == null ? void 0 : _a.trim().split(" ")) || [];
      const firstName = (nameSplit == null ? void 0 : nameSplit.slice(0, -1).join(" ")) || nameSplit[0];
      const lastName = nameSplit.length > 1 ? (nameSplit == null ? void 0 : nameSplit.slice(-1).join(" ")) || "" : "";
...
_sfc_main$g.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/SidebarTopbar/MyAccount.vue");
...
_sfc_main$f.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/SidebarTopbar/SidebarMenu.vue");
...
_sfc_main$e.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/SidebarTopbar/UserNotification.vue");
  return _sfc_setup$e ? _sfc_setup$e(props, ctx) : void 0;
};
const _sfc_main$d = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex" }, _attrs))} data-v-b8e7af12><div class="relative inline-block w-12 h-6 cursor-pointer" data-v-b8e7af12><span class="${ssrRenderClass([_ctx.$colorMode.preference === "dark" ? "bg-gray-600" : "bg-gray-100", "absolute inset-0 rounded-full transition duration-300 ease-in-out"])}" data-v-b8e7af12>`);
  if (_ctx.$colorMode.preference === "dark") {
    _push(`<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24" fill="none" stroke="#FFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-moon px-1" data-v-b8e7af12><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" data-v-b8e7af12></path></svg>`);
  } else {
    _push(`<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24" fill="none" stroke="#000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-sun px-1 ml-[23px]" data-v-b8e7af12><circle cx="12" cy="12" r="5" data-v-b8e7af12></circle><line x1="12" y1="1" x2="12" y2="3" data-v-b8e7af12></line><line x1="12" y1="21" x2="12" y2="23" data-v-b8e7af12></line><line x1="4.22" y1="4.22" x2="5.64" y2="5.64" data-v-b8e7af12></line><line x1="18.36" y1="18.36" x2="19.78" y2="19.78" data-v-b8e7af12></line><line x1="1" y1="12" x2="3" y2="12" data-v-b8e7af12></line><line x1="21" y1="12" x2="23" y2="12" data-v-b8e7af12></line><line x1="4.22" y1="19.78" x2="5.64" y2="18.36" data-v-b8e7af12></line><line x1="18.36" y1="5.64" x2="19.78" y2="4.22" data-v-b8e7af12></line></svg>`);
  }
  _push(`</span><span class="${ssrRenderClass([_ctx.$colorMode.preference === "dark" ? "translate-x-6 bg-gray-100" : "translate-x-0 bg-gray-600", "absolute left-0 top-0 w-6 h-6 rounded-full transition-transform duration-300 ease-in-out shadow"])}" data-v-b8e7af12></span></div></div>`);
}
const _sfc_setup$d = _sfc_main$d.setup;
_sfc_main$d.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/SidebarTopbar/ColorModeSwitcher.vue");
  return _sfc_setup$d ? _sfc_setup$d(props, ctx) : void 0;
};
const ColorModeSwitcher = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-b8e7af12"]]);
const _sfc_main$c = {
  __name: "Sidebar",
  __ssrInlineRender: true,
  setup(__props) {
...
_sfc_main$c.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/SidebarTopbar/Sidebar.vue");
...
const _sfc_main$b = {
  ...
  setup(__props) {
    ...
    function initializeFormFields(userInfo) {
      ...
      formInternalPhone.value = ((_c = userInfo.profile) == null ? void 0 : _c.internal_phone) || "";
      formTitleDescription.value = ((_d = userInfo.profile) == null ? void 0 : _d.title_description) || "";
      formSelectedDepartmentId.value = String(((_e = userInfo.department) == null ? void 0 : _e.id) || "");
      formPhoto.value = ((_f = userInfo.profile) == null ? void 0 : _f.profile_image_base64) || null;
    }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        _push(`<div class="info-actions pt-10 pb-5 flex gap-4 col-span-2" data-v-67eba859><button class="py-3 inline-flex justify-center rounded-3xl border border-transparent bg-red-600 py-2 px-4 text-md font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none" data-v-67eba859> \u0391\u03C0\u03BF\u03B8\u03AE\u03BA\u03B5\u03C5\u03C3\u03B7 \u0391\u03BB\u03BB\u03B1\u03B3\u03CE\u03BD </button></div></div></div>`);
      }
      _push(`</div></div>`);
    };
  }
...
_sfc_main$b.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Settings/EditUser.vue");
...
const _sfc_main$9 = {
  ...
  setup(__props) {
    ...
    const sortByFunctions = {
      ...
      "job_title": (a, b) => {
        var _a, _b;
        return (((_a = a.profile) == null ? void 0 : _a.job_title) || "").localeCompare(((_b = b.profile) == null ? void 0 : _b.job_title) || "");
      },
      "department": (a, b) => {
        var _a, _b;
        return (((_a = a.department) == null ? void 0 : _a.name) || "").localeCompare(((_b = b.department) == null ? void 0 : _b.name) || "");
      }
    };
    const filters = ref({
      firstName: "",
    ...
    const filteredUsers = computed(() => {
      let users = allUsers.value.filter(
        (user) => {
          var _a, _b;
          return (filters.value.firstName !== "" ? user.firstName.toLowerCase().includes(filters.value.firstName.toLowerCase()) : true) && (filters.value.lastName !== "" ? user.lastName.toLowerCase().includes(filters.value.lastName.toLowerCase()) : true) && (filters.value.department !== "" ? (_a = user == null ? void 0 : user.department) == null ? void 0 : _a.name.toLowerCase().includes(filters.value.department.toLowerCase()) : true) && (filters.value.job_title !== "" ? (_b = user == null ? void 0 : user.profile) == null ? void 0 : _b.job_title.toLowerCase().includes(filters.value.job_title.toLowerCase()) : true);
        }
      );
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        _push(`</div></div><div class="lg:col-span-3 lg:justify-self-end items-center" data-v-ffd41644>`);
        if (filters.value.firstName || filters.value.lastName || filters.value.job_title || filters.value.department) {
          _push(`<button class="text-red-500" data-v-ffd41644> \xD7 \u039A\u03B1\u03B8\u03B1\u03C1\u03B9\u03C3\u03BC\u03CC\u03C2 \u03C6\u03AF\u03BB\u03C4\u03C1\u03C9\u03BD </button>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div><div class="grid grid-cols-2 lg:grid-cols-12 items-center pl-[20px] pr-[50px] py-[10px] gap-[10px] font-bold" data-v-ffd41644><div class="col-span-1" data-v-ffd41644> \u03A4\u03B1\u03BE\u03B9\u03BD\u03CC\u03BC\u03B7\u03C3\u03B7 \u03BA\u03B1\u03C4\u03AC: </div><div class="cursor-pointer col-span-2 text-black dark:text-white flex items-center" data-v-ffd41644> \u038C\u03BD\u03BF\u03BC\u03B1 `);
        if (currentSortKey.value === "firstName") {
          _push(`<span class="ml-1" data-v-ffd41644>`);
          if (sortDirection.value) {
            _push(`<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-ffd41644><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7" data-v-ffd41644></path></svg>`);
          } else {
            _push(`<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-ffd41644><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-ffd41644></path></svg>`);
          }
          _push(`</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div class="cursor-pointer col-span-2 text-black dark:text-white flex items-center" data-v-ffd41644> \u0395\u03C0\u03CE\u03BD\u03C5\u03BC\u03BF `);
        ...
        _push(`</div><div class="cursor-pointer col-span-2 text-black dark:text-white flex items-center" data-v-ffd41644> \u03A4\u03AF\u03C4\u03BB\u03BF\u03C2 `);
        ...
        _push(`</div><div class="cursor-pointer col-span-2 text-black dark:text-white flex items-center" data-v-ffd41644> \u0393\u03BA\u03C1\u03BF\u03CD\u03C0 `);
...
_sfc_main$9.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Settings/UsersList.vue");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (componentLoading.value) {
        ...
        _push(`</div><div class="col-span-2" data-v-cc133653><div class="block text-sm font-bold mb-2 text-black dark:text-white" data-v-cc133653> \u03A7\u03C1\u03AE\u03C3\u03C4\u03B5\u03C2 </div>`);
        _push(ssrRenderComponent(CustomMultiSelect, {
        ...
        _push(`</div><div class="info-actions pt-10 pb-5 flex gap-4 col-span-2" data-v-cc133653><button class="py-3 inline-flex justify-center rounded-3xl border border-transparent bg-red-600 py-2 px-4 text-md font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none" data-v-cc133653> \u0391\u03C0\u03BF\u03B8\u03AE\u03BA\u03B5\u03C5\u03C3\u03B7 \u0391\u03BB\u03BB\u03B1\u03B3\u03CE\u03BD </button></div></div></div>`);
      }
      _push(`</div></div>`);
    };
  }
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Settings/EditGroup.vue");
  ...
  setup(__props) {
    ...
    const filteredGroups = computed(() => {
      let groups = departmentsStore.departmentsData.map((department) => {
        return {
          ...department,
          users: [
            ...filteredUsers.value.filter((user) => (user == null ? void 0 : user.department.id) === department.id)
          ]
        };
      });
      if (currentSortKey.value && currentSortKey.value === "department" && sortByFunctions[currentSortKey.value]) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        _push(`</div></div><div class="lg:col-span-3 lg:justify-self-end items-center" data-v-b786c1b8>`);
        if (filters.value.firstName || filters.value.lastName || filters.value.job_title || filters.value.department) {
          _push(`<button class="text-red-500" data-v-b786c1b8> \xD7 \u039A\u03B1\u03B8\u03B1\u03C1\u03B9\u03C3\u03BC\u03CC\u03C2 \u03C6\u03AF\u03BB\u03C4\u03C1\u03C9\u03BD </button>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div><div class="grid grid-cols-2 lg:grid-cols-12 items-center pl-[20px] pr-[50px] py-[10px] gap-[10px] font-bold" data-v-b786c1b8><div class="col-span-1" data-v-b786c1b8> \u03A4\u03B1\u03BE\u03B9\u03BD\u03CC\u03BC\u03B7\u03C3\u03B7 \u03BA\u03B1\u03C4\u03AC: </div><div class="cursor-pointer col-span-2 text-black dark:text-white flex items-center" data-v-b786c1b8> \u038C\u03BD\u03BF\u03BC\u03B1 `);
        if (currentSortKey.value === "firstName") {
          _push(`<span class="ml-1" data-v-b786c1b8>`);
          if (sortDirection.value) {
            _push(`<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-b786c1b8><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7" data-v-b786c1b8></path></svg>`);
          } else {
            _push(`<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-b786c1b8><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-b786c1b8></path></svg>`);
          }
          _push(`</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div class="cursor-pointer col-span-2 text-black dark:text-white flex items-center" data-v-b786c1b8> \u0395\u03C0\u03CE\u03BD\u03C5\u03BC\u03BF `);
        if (currentSortKey.value === "lastName") {
          _push(`<span class="ml-1" data-v-b786c1b8>`);
          if (sortDirection.value) {
            _push(`<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-b786c1b8><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7" data-v-b786c1b8></path></svg>`);
        ...
        _push(`</div><div class="cursor-pointer col-span-2 text-black dark:text-white flex items-center" data-v-b786c1b8> \u03A4\u03AF\u03C4\u03BB\u03BF\u03C2 `);
        if (currentSortKey.value === "job_title") {
          _push(`<span class="ml-1" data-v-b786c1b8>`);
          if (sortDirection.value) {
            _push(`<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-b786c1b8><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7" data-v-b786c1b8></path></svg>`);
        ...
        _push(`</div><div class="cursor-pointer col-span-2 text-black dark:text-white flex items-center" data-v-b786c1b8> \u0393\u03BA\u03C1\u03BF\u03CD\u03C0 `);
        if (currentSortKey.value === "department") {
          _push(`<span class="ml-1" data-v-b786c1b8>`);
          if (sortDirection.value) {
            _push(`<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-b786c1b8><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7" data-v-b786c1b8></path></svg>`);
        ...
        _push(`</div></div><div class="-m-4 p-4 mt-0" data-v-b786c1b8><div class="overflow-y-auto max-h-[50vh] pr-[15px] flex flex-col gap-[50px] -mr-[5px] [&amp;::-webkit-scrollbar]:w-2 [&amp;::-webkit-scrollbar-track]:rounded-full [&amp;::-webkit-scrollbar-track]:bg-gray-100 [&amp;::-webkit-scrollbar-thumb]:rounded-full [&amp;::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&amp;::-webkit-scrollbar-track]:bg-neutral-700 dark:[&amp;::-webkit-scrollbar-thumb]:bg-neutral-500" data-v-b786c1b8><!--[-->`);
        ssrRenderList(filteredGroups.value, (group) => {
          _push(`<div class="${ssrRenderClass(group.users.length === 0 ? "hidden" : "")}" data-v-b786c1b8>`);
          if (group.users.length) {
            _push(`<div class="grid grid-cols-2 gap-[10px]" data-v-b786c1b8><div class="h-7 translate-x-[-20px] justify-start items-center gap-5 flex" data-v-b786c1b8><div class="w-1 h-7 bg-[#ea021a] rounded-lg" data-v-b786c1b8></div><div class="text-black dark:text-white text-xl font-bold" data-v-b786c1b8>${ssrInterpolate(group.name)}</div></div><div class="justify-self-end flex gap-[25px] items-center" data-v-b786c1b8>`);
            if (unref(permissionsStore).can("group", "modify")) {
              _push(`<a class="cursor-pointer text-[#EA021A] font-bold underline" data-v-b786c1b8>\u0395\u03C0\u03B5\u03BE\u03B5\u03C1\u03B3\u03B1\u03C3\u03AF\u03B1 \u0393\u03BA\u03C1\u03BF\u03C5\u03C0</a>`);
            } else {
              _push(`<!---->`);
            }
            if (unref(permissionsStore).can("group", "modify")) {
            ...
            ssrRenderList(group.users, (user) => {
              var _a, _b, _c, _d;
              _push(`<div class="col-span-2 grid gap-[10px] grid-cols-2 lg:grid-cols-12 items-center border border-[#DFEAF2] rounded-lg pl-[20px] pr-[30px] py-[10px] hover:bg-neutral-100 dark:hover:bg-neutral-600 text-[#808080]" data-v-b786c1b8><div class="w-[50px] h-[50px] bg-gray-300 rounded-full mr-4 flex items-center justify-center col-span-1" data-v-b786c1b8>`);
              if ((_a = user == null ? void 0 : user.profile) == null ? void 0 : _a.profile_image_base64) {
                _push(`<img class="rounded-full object-cover size-[50px]"${ssrRenderAttr("src", (_b = user == null ? void 0 : user.profile) == null ? void 0 : _b.profile_image_base64)} data-v-b786c1b8>`);
              } else {
                _push(`<span class="text-white font-bold" data-v-b786c1b8>${ssrInterpolate(user.firstName.charAt(0) || "")}${ssrInterpolate(((_c = user.lastName) == null ? void 0 : _c.charAt(0)) || "")}</span>`);
              }
              _push(`</div><div class="col-span-2" data-v-b786c1b8>${ssrInterpolate(user.firstName || "")}</div><div class="col-span-2" data-v-b786c1b8>${ssrInterpolate(user.lastName || "")}</div><div class="col-span-2" data-v-b786c1b8>${ssrInterpolate(((_d = user == null ? void 0 : user.profile) == null ? void 0 : _d.job_title) || "")}</div></div>`);
            });
            _push(`<!--]--></div>`);
          } else {
            _push(`<!---->`);
      ...
      if (showModal.value) {
        ...
        ssrRenderVNode(_push, createVNode(resolveDynamicComponent(modalComponent.value), { groupId: selectedGroupId.value }, null), _parent);
        _push(`</div></div>`);
      } else {
        _push(`<!---->`);
      }
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Settings/GroupsList.vue");
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Settings/EditLeaveType.vue");
  ...
  setup(__props) {
    ...
    const filteredLeavesTypes = computed(() => {
      let leaves = allLeaves.value.filter(
        (leave) => (filters.value.leaveTypeName !== "" ? leave.name.toLowerCase().includes(filters.value.leaveTypeName.toLowerCase()) : true) && (filters.value.users !== "" ? leave.users.some((user) => user.name.toLowerCase().includes(filters.value.users.toLowerCase())) : true) && (filters.value.department !== "" ? leave.departments.some((dpt) => dpt.name.toLowerCase().includes(filters.value.department.toLowerCase())) : true)
      );
      if (currentSortKey.value && sortByFunctions[currentSortKey.value]) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        if (unref(permissionsStore).can("leave_types", "modify")) {
          _push(`<div class="info-actions pb-5 flex gap-4 col-span-2"><button class="py-3 inline-flex justify-center rounded-3xl border border-transparent bg-red-600 px-4 text-md font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none"> \u03A0\u03C1\u03BF\u03C3\u03B8\u03AE\u03BA\u03B7 \u03BD\u03AD\u03BF\u03C5 \u03C4\u03CD\u03C0\u03BF\u03C5 \u03B1\u03B4\u03B5\u03B9\u03CE\u03BD </button></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-12 items-center pl-[20px] pr-[50px] py-[10px] gap-[10px] font-bold hidden"><div class="sm:col-span-2 md:col-span-4 lg:col-span-1"> \u03A6\u03AF\u03BB\u03C4\u03C1\u03B1: </div><div class="lg:col-span-2 text-black dark:text-white"><div class="max-w-full -ml-4 inline-flex group border border-gray-200 rounded-lg transition-all focus-within:border-gray-400 transition-all hover:border-gray-400 dark:border-neutral-700 dark:hover:border-neutral-500 dark:focus-within:border-neutral-500"><input${ssrRenderAttr("value", filters.value.leaveTypeName)} class="${ssrRenderClass(`py-3 px-4 text-[16px] w-full bg-transparent border-none outline-0 ${filters.value.leaveTypeName ? "" : "rounded-r-lg"} rounded-l-lg text-sm focus:outline-none dark:bg-neutral-900 dark:text-neutral-400`)}" type="text" placeholder="\u03A4\u03CD\u03C0\u03BF\u03C2 \u03AC\u03B4\u03B5\u03B9\u03B1\u03C2">`);
        if (filters.value.leaveTypeName) {
          _push(`<button class="px-3 py-3 text-[13px] bg-white border-l border-gray-200 rounded-r-lg text-red-500 hover:bg-gray-100 transition-all dark:hover:bg-neutral-700 focus:outline-none dark:bg-neutral-900 dark:border-neutral-700"> \xD7 </button>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div><div class="lg:col-span-3 lg:justify-self-end items-center">`);
        if (filters.value.leaveTypeName || filters.value.leavesTypeDays || filters.value.users || filters.value.department) {
          _push(`<button class="text-red-500"> \xD7 \u039A\u03B1\u03B8\u03B1\u03C1\u03B9\u03C3\u03BC\u03CC\u03C2 \u03C6\u03AF\u03BB\u03C4\u03C1\u03C9\u03BD </button>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div><div class="grid grid-cols-2 lg:grid-cols-12 items-center pl-[20px] pr-[50px] py-[10px] gap-[10px] font-bold hidden"><div class="col-span-1"> \u03A4\u03B1\u03BE\u03B9\u03BD\u03CC\u03BC\u03B7\u03C3\u03B7 \u03BA\u03B1\u03C4\u03AC: </div><div class="cursor-pointer col-span-2 text-black dark:text-white flex items-center"> \u03A4\u03CD\u03C0\u03BF\u03C2 \u03AC\u03B4\u03B5\u03B9\u03B1\u03C2 `);
        if (currentSortKey.value === "leaveTypeName") {
          _push(`<span class="ml-1">`);
          if (sortDirection.value) {
            _push(`<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7"></path></svg>`);
          } else {
            _push(`<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>`);
          }
          _push(`</span>`);
        } else {
          _push(`<!---->`);
        ...
        ssrRenderList(filteredLeavesTypes.value, (leaveType) => {
          _push(`<div class="grid gap-[10px] grid-cols-2 lg:grid-cols-12 items-center border border-[#DFEAF2] rounded-lg pl-[20px] pr-[30px] py-[10px] hover:bg-neutral-100 dark:hover:bg-neutral-600 text-[#808080]"><div class="col-span-8">${ssrInterpolate(leaveType.name || "")}</div><div class="col-span-4 justify-self-end flex gap-[25px] items-center">`);
          if (unref(permissionsStore).can("leave_types", "modify")) {
            _push(`<a class="cursor-pointer text-[#EA021A] font-bold underline">\u0395\u03C0\u03B5\u03BE\u03B5\u03C1\u03B3\u03B1\u03C3\u03AF\u03B1 \u03A0\u03C1\u03BF\u03C6\u03AF\u03BB</a>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div></div>`);
      ...
      if (showModal.value) {
        _push(`<div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50"><div class="bg-white dark:bg-neutral-700 p-2 rounded-lg w-full max-w-[900px] relative"><button class="absolute top-3 right-3 text-gray-500 hover:text-gray-700"><svg class="hover:stroke-gray-500 dark:hover:stroke-gray-100 dark:stroke-gray-500" xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none" stroke="black"><path d="M1 16L16 1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M16 16L1 1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg></button>`);
        ssrRenderVNode(_push, createVNode(resolveDynamicComponent(modalComponent.value), { leaveTypeId: selectedLeaveTypeId.value }, null), _parent);
        _push(`</div></div>`);
      } else {
        _push(`<!---->`);
      }
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Settings/LeavesTypesList.vue");
  ...
  setup(__props) {
    ...
    const groupedPermissions = computed(() => {
      ...
      for (const [categoryKey, actions] of Object.entries(permissionsStore.permissions)) {
        ...
        const categoryLabel = ((_a = permissionLabels[categoryKey]) == null ? void 0 : _a.label) || categoryKey;
        ...
        for (const [actionKey, allowedRoles] of Object.entries(actions)) {
          const actionLabel = ((_b = permissionLabels[categoryKey]) == null ? void 0 : _b.actions[actionKey]) || actionKey;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(groupedPermissions.value, (group, index) => {
        _push(`<div class="mb-6"><h3 class="border-l-4 dark:text-white border-red-500 pl-[20px] ml-[-25px] text-black font-bold text-[18px] mb-4">${ssrInterpolate(group.categoryLabel)}</h3><!--[-->`);
        ssrRenderList(group.actions, (action) => {
          _push(`<div class="mb-4 ml-2"><h4 class="font-medium mb-2 dark:text-neutral-200 underline">${ssrInterpolate(action.actionLabel)}</h4><ul class="space-y-1 ml-2 flex gap-10"><!--[-->`);
          ssrRenderList(action.rolePermissions, (rolePerm) => {
            _push(`<li class="flex items-center"><span class="mr-2">`);
            ssrRenderVNode(_push, createVNode(resolveDynamicComponent(rolePerm.roleHasPermission ? unref(CheckIcon) : unref(XMarkIcon)), {
              class: ["w-5 h-5", rolePerm.roleHasPermission ? "text-green-500 dark:text-green-400" : "text-red-500 dark:text-red-400"]
            }, null), _parent);
            _push(`</span><span class="text-neutral-500 dark:text-neutral-300">${ssrInterpolate(rolePerm.roleLabel)}</span></li>`);
          });
          _push(`<!--]--></ul></div>`);
        });
        _push(`<!--]--></div>`);
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Settings/Permissions.vue");
  ...
  setup(__props) {
    ...
    const users = computed(() => userStore.allUsers.map((user) => {
      ...
      return {
        id: user.id,
        name: user.name,
        icon: ((_a = user.profile) == null ? void 0 : _a.profile_image_base64) ? `<img src="${user.profile.profile_image_base64}" class="rounded-full size-6 object-cover" />` : `<div class="bg-gray-300 rounded-full size-6 flex items-center justify-center text-white font-bold">${user.name.charAt(0)}</div>`,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-white rounded-lg duration-300 p-4 flex-1 flex flex-col dark:bg-neutral-800 dark:text-gray-100" }, _attrs))}><div class="flex-1">`);
      if (loading.value) {
        _push(`<div class="grid grid-cols-12 pt-[10px] max-w-[947px]"><div class="w-12 h-12 bg-gray-200 rounded-full col-span-2 mr-4 animate-pulse"></div><div class="pt-4 space-y-2 col-span-10 animate-pulse"><p class="h-4 bg-gray-200 rounded w-1/3 animate-pulse dark:bg-neutral-700"></p><p class="h-4 bg-gray-200 rounded w-1/2 animate-pulse dark:bg-neutral-700"></p><p class="h-4 bg-gray-200 rounded w-1/4 animate-pulse dark:bg-neutral-700"></p></div></div>`);
      } else {
        _push(`<div class="grid grid-cols-12 pt-[10px] max-w-[947px]"><div class="grid grid-cols-2 col-span-12 gap-y-[15px] gap-x-[25px]">`);
        if (!__props.entitlementId) {
          _push(`<div class="max-w-[97%] col-span-2"><label class="block text-sm font-bold mb-2 text-black dark:text-white">\u0395\u03C1\u03B3\u03B1\u03B6\u03CC\u03BC\u03B5\u03BD\u03BF\u03B9</label>`);
          _push(ssrRenderComponent(CustomMultiSelect, {
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Settings/EditEntitlement.vue");
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Settings/DeleteEntitlement.vue");
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const filteredUsers = computed(() => {
      let users = allUsers.value.filter(
        (user) => (filters.value.firstName !== "" ? user.firstName.toLowerCase().includes(filters.value.firstName.toLowerCase()) : true) && (filters.value.lastName !== "" ? user.lastName.toLowerCase().includes(filters.value.lastName.toLowerCase()) : true)
      );
      if (currentSortKey.value && sortByFunctions[currentSortKey.value]) {
        users = users.slice().sort((a, b) => {
          const result = sortByFunctions[currentSortKey.value](a, b);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        _push(`</div></div><div class="lg:col-span-3 lg:justify-self-end items-center" data-v-5ee97158>`);
        if (filters.value.firstName || filters.value.lastName || filters.value.leave_type || filters.value.year) {
          _push(`<button class="text-red-500" data-v-5ee97158> \xD7 \u039A\u03B1\u03B8\u03B1\u03C1\u03B9\u03C3\u03BC\u03CC\u03C2 \u03C6\u03AF\u03BB\u03C4\u03C1\u03C9\u03BD </button>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div><div class="grid grid-cols-2 lg:grid-cols-12 items-center pl-[20px] pr-[50px] py-[10px] gap-[10px] font-bold" data-v-5ee97158><div class="col-span-1" data-v-5ee97158> \u03A4\u03B1\u03BE\u03B9\u03BD\u03CC\u03BC\u03B7\u03C3\u03B7 \u03BA\u03B1\u03C4\u03AC: </div><div class="cursor-pointer col-span-2 text-black dark:text-white flex items-center" data-v-5ee97158> \u038C\u03BD\u03BF\u03BC\u03B1 `);
        if (currentSortKey.value === "firstName") {
          _push(`<span class="ml-1" data-v-5ee97158>`);
          if (sortDirection.value) {
            _push(`<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-5ee97158><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7" data-v-5ee97158></path></svg>`);
          } else {
            _push(`<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-5ee97158><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-5ee97158></path></svg>`);
          }
          _push(`</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div class="cursor-pointer col-span-2 text-black dark:text-white flex items-center" data-v-5ee97158> \u0395\u03C0\u03CE\u03BD\u03C5\u03BC\u03BF `);
        if (currentSortKey.value === "lastName") {
          _push(`<span class="ml-1" data-v-5ee97158>`);
          if (sortDirection.value) {
            _push(`<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-5ee97158><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7" data-v-5ee97158></path></svg>`);
      ...
      if (showModal.value) {
        ...
        ssrRenderVNode(_push, createVNode(resolveDynamicComponent(modalComponent.value), { entitlementId: selectedEntitlementId.value }, null), _parent);
        _push(`</div></div>`);
      } else {
        _push(`<!---->`);
      }
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Settings/EntitlementDays.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const EntitlementDays = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-5ee97158"]]);
const _sfc_main = {
  __name: "settings",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    function tabButtonClass(tabName) {
      const baseClasses = "py-4 px-1 inline-flex items-center gap-x-2 border-b-2 text-sm whitespace-nowrap focus:outline-none disabled:opacity-50 disabled:pointer-events-none";
      const activeClasses = "border-red-600 text-black font-bold dark:text-white";
      const inactiveClasses = "border-transparent text-gray-500 hover:text-red-600 dark:text-neutral-400 dark:hover:text-red-500";
      return [
        baseClasses,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="w-full lg:pl-64 bg-gray-100 dark:bg-neutral-900 min-h-dvh-64 duration-300"><h3 class="px-4 pt-9 sm:px-6 font-semibold text-lg dark:text-gray-100">\u03A1\u03C5\u03B8\u03BC\u03AF\u03C3\u03B5\u03B9\u03C2</h3><div class="p-4 sm:p-6 space-y-4 sm:space-y-6"><div class="w-full bg-white rounded-lg shadow-md dark:bg-neutral-800 duration-300"><div class="border-b border-gray-200 px-4 dark:border-neutral-700 duration-300"><nav class="flex gap-x-16 overflow-x-auto custom-scrollbar" aria-label="Tabs" role="tablist" aria-orientation="horizontal"><!--[-->`);
      ssrRenderList(visibleTabs.value, (tab) => {
        _push(`<button type="button" class="${ssrRenderClass(tabButtonClass(tab.name))}"${ssrRenderAttr("id", "basic-tabs-item-" + tab.name)}${ssrRenderAttr("aria-selected", activeTab.value.value === tab.name)}${ssrRenderAttr("aria-controls", "basic-tabs-" + tab.name)} role="tab">${ssrInterpolate(tab.label)}</button>`);
      });
      _push(`<!--]--></nav></div><div class="mt-3 p-4">`);
      if (activeTabObj.value) {
        _push(`<div${ssrRenderAttr("id", "basic-tabs-" + activeTabObj.value.name)} role="tabpanel"${ssrRenderAttr("aria-labelledby", "basic-tabs-item-" + activeTabObj.value.name)} class="text-gray-500 dark:text-neutral-400">`);
        ssrRenderVNode(_push, createVNode(resolveDynamicComponent(activeTabObj.value.component), activeTabObj.value.props ? activeTabObj.value.props() : {}, null), _parent);
        _push(`</div>`);
      } else {
        _push(`<!---->`);
      }
