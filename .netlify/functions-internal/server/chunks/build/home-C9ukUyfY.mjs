import { computed, resolveComponent, unref, ref, withCtx, createTextVNode, watch, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderClass, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderDynamicModel } from 'vue/server-renderer';
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/misc/FilterInput.vue");
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const filteredLeaves = computed(() => {
      const returnArray = allLeaves.value.filter((leave) => {
        const requesterNameMatch = filters.value.requesterName ? leave.user.name.toLowerCase().includes(filters.value.requesterName.toLowerCase()) : true;
        const groupMatch = filters.value.group ? leave.user.department_id && leave.user.department_id.toString().includes(filters.value.group) : true;
        const yearMatch = filters.value.year ? new Date(leave.start_date).getFullYear() === parseInt(filters.value.year) : true;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        _push(`<div${ssrRenderAttrs(_attrs)} data-v-de86da13><div class="grid gap-4 grid-cols-4 items-center border p-4 rounded-lg" data-v-de86da13><div class="flex flex-col gap-4" data-v-de86da13><div class="text-sm text-gray-500" data-v-de86da13><div class="h-8 bg-gray-400 rounded col-span-1 animate-pulse" data-v-de86da13></div></div><div class="font-bold" data-v-de86da13><div class="h-8 bg-gray-400 rounded col-span-1 animate-pulse" data-v-de86da13></div></div></div><div data-v-de86da13><div class="h-8 bg-gray-400 rounded col-span-1 animate-pulse" data-v-de86da13></div></div><div data-v-de86da13><div class="h-8 bg-gray-400 rounded col-span-1 animate-pulse" data-v-de86da13></div></div><div class="flex space-x-2" data-v-de86da13><div data-v-de86da13><div class="h-8 bg-gray-400 rounded col-span-1 animate-pulse" data-v-de86da13></div></div></div></div></div>`);
      } else {
        _push(`<div${ssrRenderAttrs(_attrs)} data-v-de86da13><div class="${ssrRenderClass([{ "mt-[45px]": props.isSmallComponent }, "grid grid-cols-2 text-black gap-y-2 dark:text-white"])}" data-v-de86da13><div class="flex flex-col col-span-2 gap-2 lg:gap-0 lg:grid grid-rows-2 grid-cols-1 lg:grid-rows-1 lg:grid-cols-2" data-v-de86da13>`);
        if (unref(permissionsStore).can("profile_leave_balance", "accept_leave")) {
          _push(`<div class="text-black dark:text-white font-bold flex items-center gap-2" data-v-de86da13> \u0391\u03B9\u03C4\u03AE\u03BC\u03B1\u03C4\u03B1 \u03AC\u03B4\u03B5\u03B9\u03B1\u03C2 <span class="text-[#EA021A]" data-v-de86da13>(${ssrInterpolate(filteredLeaves.value.length)})</span></div>`);
        } else {
          _push(`<div data-v-de86da13> \u0386\u03B4\u03B5\u03B9\u03B5\u03C2 \u03AD\u03C4\u03BF\u03C5\u03C2 </div>`);
        }
        if (!props.isSmallComponent) {
          _push(`<div class="ml-4 grid grid-cols-1 sm:grid-cols-3 gap-2 lg:gap-4 w-full lg:max-w-3xl items-end lg:justify-self-end lg:self-end" data-v-de86da13>`);
          _push(ssrRenderComponent(FilterInput, {
          ...
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(` \u038C\u03BB\u03B1 \u03C4\u03B1 \u03B1\u03B9\u03C4\u03AE\u03BC\u03B1\u03C4\u03B1 \u03AC\u03B4\u03B5\u03B9\u03B1\u03C2 `);
              } else {
                return [
                  createTextVNode(" \u038C\u03BB\u03B1 \u03C4\u03B1 \u03B1\u03B9\u03C4\u03AE\u03BC\u03B1\u03C4\u03B1 \u03AC\u03B4\u03B5\u03B9\u03B1\u03C2 ")
                ];
              }
            }),
            _: 1
        ...
        ssrRenderList(filteredLeaves.value, (leave) => {
          ...
          if (unref(permissionsStore).can("profile_leave_balance", "accept_leave")) {
            ...
            if (leave.status === "pending") {
              _push(`<button class="py-2 px-4 bg-[#16DBAA26] transition-all dark:bg-green-300 text-green-700 dark:text-green-800 dark:hover:text-green-500 rounded-md hover:bg-green-300 dark:hover:bg-green-100" data-v-de86da13>`);
            ...
            if (leave.status === "pending") {
              _push(`<button class="py-2 px-4 rounded-md transition-all bg-[#FF455F26] hover:bg-red-300 text-[#FF455F] hover:text-red-700 dark:bg-[#FF455F8F] dark:hover:bg-red-200 dark:text-[#FF455F] dark:hover:text-red-700" data-v-de86da13>`);
            ...
            _push(`<div class="justify-self-end" data-v-de86da13><button class="py-2 px-4 border-0 text-black hover:text-neutral-500 underline dark:text-white dark:hover:text-neutral-700" data-v-de86da13> \u0391\u03BA\u03CD\u03C1\u03C9\u03C3\u03B7 </button></div>`);
          }
          _push(`</div>`);
        });
        _push(`<!--]--></div></div></div>`);
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Leaves/YearlyLeaves.vue");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(centralStore).permissionsStore.can("profile_leave_balance", "accept_leave")) {
        _push(ssrRenderComponent(YearlyLeaves, {
