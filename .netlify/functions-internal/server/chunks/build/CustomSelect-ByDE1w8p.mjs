  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(
        ...
        )} data-v-03af472b><label${ssrRenderAttr('for', __props.selectId)} class="block text-sm font-bold mb-2 text-black dark:text-white" data-v-03af472b>${ssrInterpolate(__props.label)}</label><div class="cursor-pointer" data-v-03af472b><div class="py-3 px-4 flex items-center justify-between w-full border border-gray-200 rounded-lg bg-white text-sm dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400" data-v-03af472b><div data-v-03af472b>`,
      );
      if (selectedOption.value) {
        _push(`<span data-v-03af472b>${ssrInterpolate(selectedOption.value.name)}</span>`);
      } else {
        _push(
          `<span class="text-gray-400 dark:text-neutral-500" data-v-03af472b>${ssrInterpolate(__props.placeholder)}</span>`,
        );
      }
      _push(
        `</div><div data-v-03af472b><svg xmlns="http://www.w3.org/2000/svg" class="${ssrRenderClass(
          [
