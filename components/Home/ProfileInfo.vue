<template>
  ...
  <div
    class="bg-white border rounded-lg hover:shadow-md transition-shadow duration-300 py-[25px] px-[35px] flex-1 flex flex-col dark:bg-neutral-800 dark:text-gray-100"
  >
    <div class="flex-1">
      ...
      <template v-else>
        ...
        <div class="pt-[15px] space-y-2 text-[14px] leading-[16px] flex flex-col">
          ...
          <p>
            <span class="font-bold">{{ $t('settings.lastName') }}: </span
            ><span class="text-[#808080] dark:text-gray-300"> {{ lastName }}</span>
          </p>
          <p>
            <span class="font-bold">{{ $t('settings.jobTitle') }}: </span
            ><span class="text-[#808080] dark:text-gray-300"> {{ userTitle }}</span>
          </p>
          <p>
            <span class="font-bold">{{ $t('common.email') }}: </span
            ><span class="text-[#808080] dark:text-gray-300"> {{ userEmail }}</span>
          </p>
          <p>
            <span class="font-bold">{{ $t('common.phone') }}: </span
            ><span class="text-[#808080] dark:text-gray-300"> {{ userphone }}</span>
          </p>
          <p>
            <span class="font-bold">{{ $t('common.internalPhone') }}: </span
            ><span class="text-[#808080] dark:text-gray-300"> {{ user_internal_phone }}</span>
          </p>
          <p>
            <span class="font-bold">{{ $t('settings.group') }}: </span
            ><span class="text-[#808080] dark:text-gray-300"> {{ user_department }}</span>
          </p>
        </div>
      </template>
    </div>
...
const { userStore, permissionsStore } = useCentralStore();
