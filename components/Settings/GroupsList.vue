    ...
    <div class="flex flex-col gap-[10px]">
      <div
        ...
        <button
          ...
          Î ÏÎ¿ÏƒÎ¸Î®ÎºÎ· Î½Î­Î¿Ï… Î³ÎºÏÎ¿Ï…Ï€
        </button>
      </div>
          ...
          <div v-for="group in filteredGroups" :key="group.id" :class="group.users.length === 0 ? 'hidden' : ''">
            <div v-if="group.users.length" class="grid grid-cols-2 gap-[10px]">
              ...
              <div class="justify-self-end flex gap-[25px] items-center">
                <a v-if="permissionsStore.can('group','modify')" @click="editGroup(group.id)" class="cursor-pointer text-[#EA021A] font-bold underline">Î•Ï€ÎµÎ¾ÎµÏÎ³Î±ÏƒÎ¯Î± Î“ÎºÏÎ¿Ï…Ï€</a>
