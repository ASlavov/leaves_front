      ...
      <div class="relative -m-4 p-4 mt-0">
        ...
        >
          <div
            ...
            :key="user.id"
            :class="`flex flex-col border border-gray-200 dark:border-neutral-700 rounded-lg ${!toggledUsers[String(user.id)] ? 'hover:bg-neutral-100 dark:hover:bg-neutral-700/50 pl-[20px] pr-[30px] py-[10px]' : ''} text-gray-500 dark:text-neutral-300`"
          >
                ...
                <div class="min-w-[500px]">
                  ...
                  >
                    ...
                    <div class="justify-self-end flex gap-[25px] items-center">
                      ...
                      <svg
                        v-if="permissionsStore.can('entitlement', 'modify')"
                        class="cursor-pointer text-gray-600 dark:text-gray-300 hover:text-red-500 dark:hover:text-red-400 transition-colors"
