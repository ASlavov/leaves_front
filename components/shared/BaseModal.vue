<template>
  <Teleport to="body">
    <div
      v-if="modelValue"
      class="fixed inset-0 lg:inset-[0_0_0_259px] 2xl:inset-0 z-50 overflow-y-auto bg-black bg-opacity-50"
      @click.self="$emit('update:modelValue', false)"
    >
      <div class="flex min-h-full items-center justify-center p-4" @click.self="$emit('update:modelValue', false)">
      <div
        :class="[
