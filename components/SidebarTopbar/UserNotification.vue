    ...
    <div class="relative" ref="dropdownContainer">
        ...
        <div v-if="showNotifications" class="fixed top-[60px] right-0 h-full w-80 bg-white border border-gray-200 shadow-lg dark:bg-neutral-800 dark:border-neutral-600 overflow-y-auto z-[100]">
            ...
            <ul class="divide-y divide-gray-200 dark:divide-neutral-600">
                <li @click="changeNotificationStatus(notification.id)" v-for="notification in filteredNotifications" :key="notification.id" class="p-4 text-sm text-gray-700 dark:text-gray-300 opacity-90 hover:opacity-100 cursor-pointer hover:bg-gray-50 dark:hover:bg-neutral-700/50 transition-all">
