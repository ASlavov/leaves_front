...
```html
<div class="bg-white dark:bg-neutral-700 rounded-lg w-full max-w-[900px] relative"></div>
```
...
```html
<div
  class="bg-white dark:bg-neutral-900 rounded-[10px] w-full max-w-[675px] relative
...
```html
<div class="grid grid-cols-12 pt-[30px] max-w-[947px]"></div>
```
...
```html
<div
  class="relative w-[132px] h-[132px] bg-gray-300 rounded-full mr-4 flex items-center justify-center col-span-2"
>
...
```html
<input
  class="py-3 px-4 block w-full border-gray-200 border rounded-lg transition-all
...
```html
<input
  class="h-[40px] py-[8px] px-[16px] block w-full
...
```html
<label class="block text-sm font-bold mb-2 text-black dark:text-white"></label>
```

**Target:**

```html
<label class="block text-[14px] font-bold mb-[8px] text-black dark:text-gray-100"></label>
```
...
```html
<button
  class="py-3 inline-flex justify-center rounded-3xl border border-transparent
...
<div class="grid grid-cols-12 pt-[30px] max-w-[947px]">
  ...
  <div class="pt-4 space-y-2 col-span-10 ...">...</div>
</div>
```
...
const submitBtnClass =
  'inline-flex items-center justify-center py-[15px] px-[20px] rounded-[70px] bg-[#EA021A] hover:bg-red-700 text-[14px] font-bold text-white transition-colors focus:outline-none';
```
...
```html
<div
  class="h-[40px] py-[8px] px-[16px] flex items-center justify-between w-full
