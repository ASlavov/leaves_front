...
// Minimal but comprehensive country list: [iso2, name, dialCode]
export const RAW_COUNTRIES: [string, string, string][] = [
  ['af', 'Afghanistan', '93'],
  ['al', 'Albania', '355'],
  ['dz', 'Algeria', '213'],
  ['ad', 'Andorra', '376'],
...
export const COUNTRIES: Country[] = RAW_COUNTRIES.map(([iso2, name, dialCode]) => ({
  iso2,
  name,
  dialCode,
  flag: flagEmoji(iso2),
...
export const findByIso2 = (iso2: string) =>
  COUNTRIES.find((c) => c.iso2 === iso2) ?? COUNTRIES.find((c) => c.iso2 === 'gr')!;
